...
<template>
  ...
  <el-form :model="admin_loginForm" :rules="rules" class="login-container" label-position="left"
    ...
    <el-form-item prop="username">
      <el-input type="text" v-model="admin_loginForm.username"
                auto-complete="off" placeholder="账号"></el-input>
    </el-form-item>
    <el-form-item prop="password">
    <!--<h6 class="password_rule">密码开头两个字母必须是ld</h6>-->
      <el-input type="password" v-model="admin_loginForm.password"
                auto-complete="off" placeholder="密码"></el-input>
    </el-form-item>

    <el-form-item style="width: 100%">
      <el-button type="primary" style="width: 40%;background: #505458;border: none" v-on:click="admin_login">登录</el-button>
    </el-form-item>
  ...
  export default {
    ...
    methods: {
      admin_login () {
        this.$axios
          .post('/admin_login', {
            username: this.admin_loginForm.username,
            password: this.admin_loginForm.password
          })
      ...
      goto() {
        this.$axios
          .get('/admin_login/'+this.admin_loginForm.username+'/goto')
          .then(successResponse => {
            if (successResponse.data.code === 200) {
