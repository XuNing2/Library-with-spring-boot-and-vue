  ...
  <div>
    <el-row style="height: 840px;">
      ...
      <el-tooltip effect="dark" placement="right"
        ...
        <el-card style="width: 135px;margin-bottom: 20px;height: 238px;float: left;margin-right: 15px" class="book"
          ...
          <div class="info">
            <div class="title">
              <a href="">{{item.title}}</a>
                <el-button type="text" @click="gotolink" class="btn btn-success">修改图书</el-button>
            </div>
          </div>
...
<script>
  ...
  export default {
    ...
    methods: {
         gotolink(){
          //指定跳转地址
          this.$router.replace('/admin/changeBook')
        },
      loadBooks () {
        var _this = this
